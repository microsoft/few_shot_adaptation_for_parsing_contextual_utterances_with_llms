...
def create_partial_parse_builder(
    ...
    if constrained:
        ...
        if data_config.dataset_name in [
            ...
            BenchClampDataset.CalFlowFindEvent.value,
            BenchClampDataset.CalFlowFindEventSubset.value,
            BenchClampDataset.CalFlowFindEventRevise.value,
            BenchClampDataset.CalFlowFindEventTrainReviseDev.value,
            BenchClampDataset.CalFlowFindEventReviseEditFragment.value,
