...
def main():
    ...
    write_data_and_grammar(train_dataflow_dialogues_jsonl=BENCH_CLAMP_RAW_DATA_DIR / f"{BenchClampDataset.CalFlowFindEventRevise}/20230222-find_event_revise.train.proportional_split.smcalformat.jsonl",
                         dev_dataflow_dialogues_jsonl=BENCH_CLAMP_RAW_DATA_DIR / f"{BenchClampDataset.CalFlowFindEventRevise}/20230222-find_event_revise.valid.proportional_split.smcalformat.jsonl",
                         test_dataflow_dialogues_jsonl=None,
                         datum_output_dir=BENCH_CLAMP_PROCESSED_DATA_DIR
        / f"{BenchClampDataset.CalFlowFindEventRevise}/",
                         grammar_output_dir=BENCH_CLAMP_GRAMMAR_DATA_DIR
    ...
    write_data_and_grammar(train_dataflow_dialogues_jsonl=BENCH_CLAMP_RAW_DATA_DIR / f"{BenchClampDataset.CalFlowFindEventReviseEditFragment}/{date}-find_event_revise.train.proportional_split.edit_fragment_plan.smcalformat.jsonl",
                         dev_dataflow_dialogues_jsonl=BENCH_CLAMP_RAW_DATA_DIR / f"{BenchClampDataset.CalFlowFindEventReviseEditFragment}/{date}-find_event_revise.valid.proportional_split.edit_fragment_plan.smcalformat.jsonl",
                         test_dataflow_dialogues_jsonl=None,
                         datum_output_dir=BENCH_CLAMP_PROCESSED_DATA_DIR
        / f"{BenchClampDataset.CalFlowFindEventReviseEditFragment}/",
                         grammar_output_dir=BENCH_CLAMP_GRAMMAR_DATA_DIR
        / f"{BenchClampDataset.CalFlowFindEventReviseEditFragment}/",
    )
